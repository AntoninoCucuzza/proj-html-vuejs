        ...
        <div class="product">
            ...
            <div class="info position-relative">
                <div class="d-flex vote">
                    ...
                    <div class="negative" v-for="asd in (5 - stars) " v-html="vote"></div>
                </div>
                <h6 class="px-2">{{ title }}</h6>
                <p class="m-0 price pb-2 px-2">
                    <span> <span class="discount">{{ discount }}</span> {{ price }} </span>
                    <span> {{ pricetwo }}</span>
                </p>
